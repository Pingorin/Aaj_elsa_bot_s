...
class Database:
    ...
    def __init__(self):
        ...
        # --- FIX: 'join_requests' collection se sambandhit line hata di gayi hai ---
        # self.join_requests = mydb.join_requests (REMOVED)
    ...
    # --- FIX: 'Advanced Fsub' ke sabhi database functions hata diye gaye hain ---
    # (add_join_request, is_join_request_pending, remove_join_request, del_join_req)
    # --- YEH FUNCTIONS HATA DIYE GAYE HAIN ---
