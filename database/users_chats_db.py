...
from info import (
    ...
    # Naya variable import kiya gaya
    DEFAULT_VERIFY_TIME 
)
# --- BADLAAV KHATAM ---
...
class Database:
    ...
    default = {
            ...
            # Default time ab 24 ghante (DEFAULT_VERIFY_TIME) hai
    ...
    async def get_notcopy_user(self, user_id):
        ...
        if not user:
            res = {
                ...
                # --- YEH HAI ASLI FIX (DATES SWAPPED) ---
                # V1 (last_verified) sabse purana (2019)
                # V2 (second_time_verified) naya (2020)
