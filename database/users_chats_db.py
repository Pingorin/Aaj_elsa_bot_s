...
class Database:
    ...
    async def get_notcopy_user(self, user_id):
        ...
        if not user:
            res = {
                "user_id": user_id,
                # --- FIX: Dono timestamp ko ek hi (purane) time par set kiya ---
    ...
    # --- Puraane logic functions (is_user_verified, is_user_verified_second, use_second_shortener) ---
    # --- Yahan se hata diye gaye hain, kyunki unki zaroorat nahi hai ---
