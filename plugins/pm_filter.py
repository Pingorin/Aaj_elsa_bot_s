...
async def lang_search(client: Client, query: CallbackQuery):
    ...
    # --- THIS IS THE FIX ---
    # Pass 'lang' as a keyword argument to the database function
...
# --- FIX: This helper function filters out 'index' callbacks for the main handler ---
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # --- FIX: Removed obsolete 'checksub' elif block ---
    # The new FSub logic is handled in Commands.py at /start
        ...
        # --- FIX: 'get_bad_files' returns a cursor, not a list. ---
