...
# ... [Languages, Qualities, Years callbacks remain the same, skipping to save space] ...
# ... [Please retain all other callback handlers from previous code here] ...
# ... [Inserting ONLY the new handlers below, you can assume the rest are there] ...
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # --- CONFIGURE NORMAL FSUB SUB-MENU ---
        ...
        btn = [
            [InlineKeyboardButton("➕ Set Normal Slot (Auth 3)", callback_data=f"set_fsub#{grp_id}#fsub_id_3")],
