...
async def start(client:Client, message): 
    ...
    if len(m.command) == 2 and m.command[1].startswith('notcopy'):
        ...
        try:
            ...
            v3_time = user_data.get("third_time_verified", datetime.datetime(2021, 5, 17, 0, 0, 0, tzinfo=ist_timezone)) # Failsafe
        except Exception:
            # Failsafe agar DB mein keys missing hain
            v1_time = datetime.datetime(2019, 5, 17, 0, 0, 0, tzinfo=ist_timezone)
            v2_time = datetime.datetime(2020, 5, 17, 0, 0, 0, tzinfo=ist_timezone)
            v3_time = datetime.datetime(2021, 5, 17, 0, 0, 0, tzinfo=ist_timezone)
