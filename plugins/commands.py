...
from info import (
    ...
    AUTH_CHANNEL_3, AUTH_CHANNEL_3_INVITE_LINK, # <-- YEH FIX HAI
...
async def start(client:Client, message): 
    ...
    # --- YEH HAI AAPKA NAYA 3-CHANNEL FSUB LOGIC (LAYOUT FIX KE SAATH) ---
    if AUTH_CHANNEL or AUTH_CHANNEL_2 or AUTH_CHANNEL_3:
        ...
        if all_joined:
            ...
            # Channel 1 ke liye button (Advanced)
            ...
            # Channel 2 ke liye button (Advanced)
