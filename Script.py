...
💶 ꜱᴇɴᴅ /plan ᴛᴏ ʙᴜʏ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ</b>"""
    ...
    THIRD_VERIFICATION_TEXT = """<b>ʜᴇʏ {} 👋
 
ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ.
ᴛᴏ ᴠᴇʀɪғʏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ.
 
ᴡᴀɪᴛ ғᴏʀ ᴛʜᴇ ᴛɪᴍᴇʀ ᴛᴏ ᴇxᴘɪʀᴇ ᴀɴᴅ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴜᴛᴛᴏɴ.
 
ᴛʜɪs ɪs ᴛʜᴇ (3/3) ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴘᴀɢᴇ...</b>"""

    THIRD_VERIFY_COMPLETE_TEXT = """<b>ᴛʜɪʀᴅ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ✅</b>
